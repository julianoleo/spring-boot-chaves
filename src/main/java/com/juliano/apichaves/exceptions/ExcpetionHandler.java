...
import com.juliano.apichaves.exceptions.models.CamposErros;
import com.juliano.apichaves.exceptions.models.DetalhesExcecao;
...
public class ExcpetionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(com.juliano.apichaves.exceptions.NoContentRuntimeException.class)
    protected ResponseEntity<List<ErrorResponseDto>> handleNoContentRuntimeException(com.juliano.apichaves.exceptions.NoContentRuntimeException ex, HttpServletRequest request) {
